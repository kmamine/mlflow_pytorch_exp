...
PACKAGES = [
    ...
    "requests==2.32.3",
    "threadpoolctl==3.5.0",
    "torch==2.3.1+cu118 @ https://download.pytorch.org/whl/cu118",
    "torchaudio==2.3.1+cu118 @ https://download.pytorch.org/whl/cu118",
    "torchvision==0.18.1+cu118 @ https://download.pytorch.org/whl/cu118",
    "triton==2.3.1",
